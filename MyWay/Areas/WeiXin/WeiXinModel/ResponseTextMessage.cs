...
namespace MyWay.Areas.WeiXin.WeiXinModel
{
    ...
    public class ResponseTextMessage : ResponseBaseMessage
    {
        ...
        public ResponseTextMessage(string toUserName, string fromUserName, DateTime createTime,
            string content)
            : base(toUserName, fromUserName, createTime, ResponseMessageTypeEnum.text)
        {
            Content = content;
        }
