...
namespace MyWay.Areas.WeiXin.WeiXinModel
{
    ...
    public class ResponseBaseMessage
    {
        ...
        public ResponseBaseMessage(string toUserName, string fromUserName, DateTime createTime, ResponseMessageTypeEnum msgType)
        {
        ...
        {
            return CreateXmlElement(doc, name, MyWay.Areas.WeiXin.Models.Utility.ToWeixinTime(data).ToString(), XmlNodeType.Text);
        }
