...
namespace MyWay.Areas.WeiXin.Meterial
{
    ...
    public static class MultiMediaHelper
    {
        ...
        public static MultiMediaUploadResult Upload(string userName, MultiMediaTypeEnum type, string pathName, out ErrorMessage errorMessage, out string responseContent)
        {
            ...
            responseContent = HttpHelper.Upload(url, pathName);
