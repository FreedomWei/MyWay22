...
GetPageList(sousuo, 1);

function GetPageList(sousuo, pageIndex) {
    ...
    $.post2('/home/GetSouSuoContent', { sousuo: sousuo, pageIndex: pageIndex }, function (data) {
        ...
        if (jsondata.cList.length > 0) {
            ...
            htmlPage += "<li style=\"float:left;padding:0 3px 0 3px;\"><select class=\"form-control\" onchange=\"GetPageList('"+sousuo+"',this.value)\">";
            ...
            htmlPage += "<li id=\"weiye\"><a href=\"javascript:;\" onclick=\"GetPageList('" + sousuo + "'," + jsondata.pageCount + ");\">尾页</a></li>";
            $('#page').html(htmlPage);
            ...
            if (jsondata.pageThis == 1) {
                ...
                shangyiyehtml.html("<a href=\"javascript:;\" aria-label=\"Previous\" onclick=\"GetPageList('" + sousuo + "'," + shangyiye + ");\"><span aria-hidden=\"true\">上一页</span></a>");
                shouye.html("<a href=\"javascript:;\" onclick=\"GetPageList('" + sousuo + "',1);\">首页</a>");
            }
            if (jsondata.pageThis == jsondata.pageCount) {
                ...
                xiayiyehtml.html("<a href=\"javascript:;\" aria-label=\"Next\" onclick=\"GetPageList('" + sousuo + "'," + xiayiye + ");\"><span aria-hidden=\"true\">下一页</span></a>");
                weiye.html("<a href=\"javascript:;\" onclick=\"GetPageList('" + sousuo + "'," + jsondata.pageCount + ");\">尾页</a>");
            }
            ...
            //生成跳转页码按钮
            var tiaozhuan = '';
            tiaozhuan += "<span><input class=\"text text-info\" type=\"text\" id=\"tiaozhuanpage\" name=\"number\" value=" + jsondata.pageThis + " style=\"width:50px\" onkeyup=\"key(this.value)\"/> <button class=\"btn btn-sm btn-primary\" onclick=\"GetPageList('" + sousuo + "',GetPage());\"> 跳转 </button></span> ";
            ...
            $("body").textSearch(sousuo, { markColor: "green" });
        } 
    })
}
